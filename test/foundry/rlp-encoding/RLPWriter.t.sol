...
contract RLPWriter_Test is DSTestPlus {
    ...
    function test_writeUint_zero() external {
        assertBytesEq(RLPWriter.writeUint(0x0), hex"80");
    }

    function test_writeUint_smallint() external {
        assertBytesEq(RLPWriter.writeUint(1), hex"01");
    }

    function test_writeUint_smallint2() external {
        assertBytesEq(RLPWriter.writeUint(16), hex"10");
    }

    function test_writeUint_smallint3() external {
        assertBytesEq(RLPWriter.writeUint(79), hex"4f");
    }

    function test_writeUint_smallint4() external {
        assertBytesEq(RLPWriter.writeUint(127), hex"7f");
    }

    function test_writeUint_mediumint() external {
        assertBytesEq(RLPWriter.writeUint(128), hex"8180");
    }

    function test_writeUint_mediumint2() external {
        assertBytesEq(RLPWriter.writeUint(1000), hex"8203e8");
    }

    function test_writeUint_mediumint3() external {
        assertBytesEq(RLPWriter.writeUint(100000), hex"830186a0");
    }

    function test_writeList_empty() external {
        assertBytesEq(RLPWriter.writeList(new bytes[](0)), hex"c0");
    }
    ...
    function test_writeList_stringList() external {
        ...
        assertBytesEq(RLPWriter.writeList(list), hex"cc83646f6783676f6483636174");
    }
    ...
    function test_writeList_multiList() external {
        ...
        assertBytesEq(RLPWriter.writeList(list), hex"c6827a77c10401");
    }
    ...
    function test_writeList_listoflists() external {
        ...
        assertBytesEq(RLPWriter.writeList(list), hex"c4c2c0c0c0");
    }
    ...
    function test_writeList_listoflists2() external {
        ...
        assertBytesEq(RLPWriter.writeList(list), hex"c7c0c1c0c3c0c1c0");
    }
