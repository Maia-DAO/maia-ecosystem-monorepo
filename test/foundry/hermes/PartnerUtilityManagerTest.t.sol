...
import { MockPartnerUtilityManager, IPartnerUtilityManager, IUtilityManager, UtilityManager } from "./mocks/MockPartnerUtilityManager.t.sol";
...
contract PartnerUtilityManagerTest is DSTestPlus {
    ...
    function testClaimMultipleAmounts(
        uint256 weight,
        uint256 boost,
        uint256 governance
    ) public {
    ...
    function testForfeitMultipleAmounts(
        uint256 weight,
        uint256 boost,
        uint256 governance
    ) public {
