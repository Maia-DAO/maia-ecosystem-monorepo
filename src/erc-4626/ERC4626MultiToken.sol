...
abstract contract ERC4626MultiToken is ERC20 {
    ...
    constructor(ERC20[] memory _assets, uint256[] memory _weights, string memory _name, string memory _symbol)
    ...
    function deposit(uint256[] memory assetsAmounts, address receiver) public virtual returns (uint256 shares) {
    ...
    function mint(uint256 shares, address receiver) public virtual returns (uint256[] memory assetsAmounts) {
