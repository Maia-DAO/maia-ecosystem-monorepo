...
contract GovernorBravoConstantsSeverity1 {
    ...
    uint256 public constant MIN_PROPOSAL_THRESHOLD = 100000e18; // 100,000 GovToken

    /// @notice The maximum setable proposal threshold
    uint256 public constant MAX_PROPOSAL_THRESHOLD = 1000000e18; // 1,000,000 GovToken
    ...
    uint256 public constant quorumVotes = 4000000e18; // 4,000,000 = about 4% of GovToken

    /// @notice The maximum number of actions that can be included in a proposal
    uint256 public constant proposalMaxOperations = 10; // 10 actions
}

contract GovernorBravoDelegate is GovernorBravoDelegateStorageV2, GovernorBravoEvents, GovernorBravoConstantsSeverity1 {
