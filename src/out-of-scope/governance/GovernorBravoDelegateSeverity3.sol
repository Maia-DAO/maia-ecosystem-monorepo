...
contract GovernorBravoConstantsSeverity3 {
    ...
    uint256 public constant MIN_PROPOSAL_THRESHOLD = 500000e18; // 500,000 GovToken

    /// @notice The maximum setable proposal threshold
    uint256 public constant MAX_PROPOSAL_THRESHOLD = 5000000e18; // 5,000,000 GovToken
    ...
    uint256 public constant quorumVotes = 25000000e18; // 25,000,000 = about 25% of GovToken

    /// @notice The maximum number of actions that can be included in a proposal
    uint256 public constant proposalMaxOperations = 10; // 10 actions
}

contract GovernorBravoDelegate is GovernorBravoDelegateStorageV2, GovernorBravoEvents, GovernorBravoConstantsSeverity3 {
