...
contract GovernorBravoConstantsSeverity5 {
    ...
    uint256 public constant MIN_PROPOSAL_THRESHOLD = 1000000e18; // 1,000,000 GovToken

    /// @notice The maximum setable proposal threshold
    uint256 public constant MAX_PROPOSAL_THRESHOLD = 10000000e18; // 10,000,000 GovToken
    ...
    uint256 public constant quorumVotes = 50000000e18; // 50,000,000 = about 50% of GovToken

    /// @notice The maximum number of actions that can be included in a proposal
    uint256 public constant proposalMaxOperations = 10; // 10 actions
}

contract GovernorBravoDelegate is GovernorBravoDelegateStorageV2, GovernorBravoEvents, GovernorBravoConstantsSeverity5 {
    ...
    function propose(
        ...
        require(
            govToken.getPriorVotes(msg.sender, sub256(block.number, 1)) > proposalThreshold ||
    ...
    function cancel(uint256 proposalId) external {
        ...
        if (msg.sender != proposal.proposer && msg.sender != admin) {
            ...
            if (isWhitelisted(proposal.proposer)) {
                require(
                    (govToken.getPriorVotes(proposal.proposer, sub256(block.number, 1)) < proposalThreshold) &&
