...
contract GovernorBravoConstantsSeverity4 {
    ...
    uint256 public constant MIN_PROPOSAL_THRESHOLD = 750000e18; // 750,000 GovToken

    /// @notice The maximum setable proposal threshold
    uint256 public constant MAX_PROPOSAL_THRESHOLD = 7500000e18; // 7,500,000 GovToken
    ...
    uint256 public constant quorumVotes = 35000000e18; // 35,000,000 = about 35% of GovToken

    /// @notice The maximum number of actions that can be included in a proposal
    uint256 public constant proposalMaxOperations = 10; // 10 actions
}

contract GovernorBravoDelegate is GovernorBravoDelegateStorageV2, GovernorBravoEvents, GovernorBravoConstantsSeverity4 {
