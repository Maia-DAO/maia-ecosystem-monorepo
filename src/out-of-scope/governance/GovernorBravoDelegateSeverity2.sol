...
contract GovernorBravoConstantsSeverity2 {
    ...
    uint256 public constant MIN_PROPOSAL_THRESHOLD = 250000e18; // 250,000 GovToken

    /// @notice The maximum setable proposal threshold
    uint256 public constant MAX_PROPOSAL_THRESHOLD = 2500000e18; // 2,500,000 GovToken
    ...
    uint256 public constant quorumVotes = 12500000e18; // 12,500,000 = about 12.5% of GovToken

    /// @notice The maximum number of actions that can be included in a proposal
    uint256 public constant proposalMaxOperations = 10; // 10 actions
}

contract GovernorBravoDelegate is GovernorBravoDelegateStorageV2, GovernorBravoEvents, GovernorBravoConstantsSeverity2 {
